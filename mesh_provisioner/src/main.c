...
extern int debugbuf(uint8_t* buf,int size);
...
static void setup_cdb(void)
{
	...
	uint8_t app_key[16] = {0x8f,0x94,0xe8,0x3a,0xb8,0x63,0x5a,0xb3,0xff,0x69,0x6a,0x7f,0x39,0xa8,0xe5,0x46};
	...
	if (IS_ENABLED(CONFIG_BT_SETTINGS)) {
		...
		printk("APP KEY :\n");
		debugbuf(key->keys[0].app_key,16);
	}
}
...
static int bt_ready(void)
{
	...
	int err;
	uint8_t net_key[16] = {0xa0,0x90,0x72,0x10,0x79,0x21,0xb0,0x68,0x10,0xcc,0xde,0x9d,0x02,0x26,0x07,0xdc};
	uint8_t dev_key[16] = {0xb7,0xb4,0x5d,0xd7,0xc3,0x00,0x1e,0x0d,0x99,0x33,0x65,0x27,0x9a,0x9e,0xe6,0x84};
